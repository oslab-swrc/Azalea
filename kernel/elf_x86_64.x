...
SECTIONS
{
  ...
  PROVIDE (__executable_start = SEGMENT_START("text-segment", 0xFFFF8000C0200000)); . = SEGMENT_START("text-segment", 0xFFFF8000C0200000) + SIZEOF_HEADERS;
  .interp         : { *(.interp) }
