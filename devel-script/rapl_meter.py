...
if __name__ == "__main__":
	pmterm = RaplMeter()
	os.system("./sideloader/utils/ipocap_set_limit 0")
	...
	for i in range(100):
		...
		print("%f\t%.2f" % (i*0.02, pmterm.get_power()[2]))

	os.system("./sideloader/utils/ipocap_set_limit 57")
	...
	for i in range(200):
		...
		print("%f\t%.2f" % ((i+100)*0.02, pmterm.get_power()[2]))
