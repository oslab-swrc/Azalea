...
#define OFFLOAD_CHANNEL_STRUCT_PA (CONFIG_SHARED_MEMORY_PA + (PAGE_SIZE_4K * 10))
#define OFFLOAD_CHANNEL_INFO_PA (CONFIG_SHARED_MEMORY_PA + (PAGE_SIZE_4K * 18))
#define OFFLOAD_CHANNEL_BASE_PA (CONFIG_SHARED_MEMORY_PA + (PAGE_SIZE_4K * 19))

#define CONFIG_SHARED_MEMORY_VA	(0xFFFF800080000000)
#define OFFLOAD_CHANNEL_LOCK_VA (CONFIG_SHARED_MEMORY_VA)	
#define OFFLOAD_CHANNEL_STRUCT_VA (CONFIG_SHARED_MEMORY_VA + (PAGE_SIZE_4K * 10))
#define OFFLOAD_CHANNEL_INFO_VA (CONFIG_SHARED_MEMORY_VA + (PAGE_SIZE_4K * 18))
#define OFFLOAD_CHANNEL_BASE_VA (CONFIG_SHARED_MEMORY_VA + (PAGE_SIZE_4K * 19))
